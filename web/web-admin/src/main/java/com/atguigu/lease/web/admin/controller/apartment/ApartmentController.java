...
public class ApartmentController {
    ...
    public Result saveOrUpdate(@RequestBody ApartmentSubmitVo apartmentSubmitVo) {
        service.savaOrUpdateApartment(apartmentSubmitVo);
        return Result.ok();
    }
    ...
    public Result<List<ApartmentInfo>> listInfoByDistrictId(@RequestParam Long id) {
        ...
        LambdaQueryWrapper<ApartmentInfo> eq = new LambdaQueryWrapper<ApartmentInfo>().eq(ApartmentInfo::getDistrictId, id);
        List<ApartmentInfo> list= service.list(eq);
