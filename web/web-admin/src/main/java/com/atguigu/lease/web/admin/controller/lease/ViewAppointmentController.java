...
public class ViewAppointmentController {
    ...
    public Result<IPage<AppointmentVo>> page(@RequestParam long current, @RequestParam long size, AppointmentQueryVo queryVo) {
        ...
        IPage<AppointmentVo> result= service.pageAppointment(appointmentVoPage,queryVo);
    ...
    public Result updateStatusById(@RequestParam Long id, @RequestParam AppointmentStatus status) {
        ...
        LambdaUpdateWrapper<ViewAppointment> viewAppointmentLambdaUpdateWrapper1 = new LambdaUpdateWrapper<>();
        viewAppointmentLambdaUpdateWrapper1.eq(ViewAppointment::getId, id);
        viewAppointmentLambdaUpdateWrapper1.set(ViewAppointment::getUpdateTime,new Date());
        service.update(viewAppointmentLambdaUpdateWrapper1);
        return Result.ok();
    }
